...
<div class="dark:bg-black">
  ...
  <div class="relative flex flex-col md:flex-row justify-between text-4xl md:text-6xl lg:text-8xl pt-16 md:pt-32 py-12 px-8 md:px-16 lg:px-32 font-helmed text-black dark:text-white">
    <span>
      Informasi Tiket
    </span>
    ...
    <div class="container max-w-full md:max-w-96 rounded-lg shadow-xl">
      ...
      <div class="flex justify-center flex-col items-center pt-2 pb-2">
        <h2 class="border rounded-lg flex flex-col bg-stone-700 bg-gradient-to-r from-gray-700 to-black border-black shadow-2xl shadow-inner text-xl md:text-2xl pt-2 py-2 px-4 text-black flex justify-center dark:text-white">
          <span class="font-hellight">
           Rp. {{$paketdata->harga}}
          </span>
          <span>
            Paket 1
        ...
        <a href="{{route('paymentgateway')}}" class="flex flex-col justify-center pr-6 pt-2 rounded-lg shadow-xl text-xl md:text-2xl font-hellight">
  ...
  <div class="container text-lg md:text-xl text-white font-hellight pb-8 px-8 md:px-24 lg:px-48">
    <span>
      {{$paketdata->deskripsi}}
    </span>
  </div>
