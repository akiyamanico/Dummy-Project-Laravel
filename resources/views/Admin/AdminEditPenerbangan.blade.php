                ...
                <div class="bg-slate-800  rounded shadow-lg px-4 p-8 mb-6">
                    <div class="grid text-sm grid-cols-1 lg:grid-cols-2">
                        <div class="text-white">
                            <p class="font-creal text-lg">Pengeditan Penerbangan</p>
                        </div>
                        <form action="{{route('admineditpenerbanganproses', $data->id)}}" method="post">
                            @csrf
                            <div class="lg:col-span-2">
                                <div class="grid gap-4 gap-y-2 text-white text-sm grid-cols-1 md:grid-cols-5">
