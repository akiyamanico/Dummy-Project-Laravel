                    ...
                    <div class="form">
                        <div class="md:space-y-2 mb-3">
                            <div class="flex justify-center py-6">
                                <div class="mr-4 flex-none items-center rounded-xl border overflow-hidden">
                        ...
                        <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                            <div class="mb-3 space-y-2 w-full text-xs">
                                ...
                                <input placeholder="Nama Barang"
                                    ...
                                    required="required" type="text" value="{{$produk->namaproduk}}" name="namaproduk">
                            </div>
                            <div class="mb-3 space-y-2 w-full text-xs">
                                <label class="font-semibold text-gray-600 py-2">Kategori</label>
                                <input placeholder="Kategori Barang"
                                    class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"
                                    required="required" type="text" value="{{$produk->kategori}}" name="kategori">
                            </div>
                        </div>
                        <div class="mb-3 space-y-2 w-full text-xs">
                        ...
                        <div class="flex-auto w-full mb-1 text-xs space-y-2">
                            ...
                            <textarea required="" name="deskripsi"
                                ...
                                placeholder="{{$produk->deskripsi}}" spellcheck="false" value="{{$produk->deskripsi}}"></textarea>
                        </div>
